Public Class clsSerialNumber
    ...
    Public Function getObject(Optional workOrder As String = "") As Object
        ...
        objResponse = objApiService.getJsonObject(vUrl + "/api/serialnumber/?number=" + vSn &
                                                  "&wip=true")
        '---Finding Serial number object --rue
        'Return multiple Record
        'Current workOrder is WIP=True

        If objResponse("results").length = 0 Then
        ...
        For Each obj In objResponse("results")
            vSn = obj("number")
