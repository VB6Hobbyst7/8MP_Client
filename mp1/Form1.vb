...
Public Class Form1
    ...
    'Private Sub rtScriptBox_TextChanged(sender As Object, e As EventArgs)
    ...
    'Private Sub rtScriptBox_KeyPress(sender As Object, e As KeyPressEventArgs)
    ...
    'Private Sub rtScriptBox_VScroll(sender As Object, e As EventArgs)
    '    lineTextBox.Text = ""
