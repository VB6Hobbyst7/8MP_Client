...
Public Class ucParamOption
    ...
    Private Sub ucParamList_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        '--------------
        Me.AutoSize = True
        vDefaultValue = getOptionChecked()
    End Sub
    ...
    Friend Sub clist_SelectionChangeCommitted(sender As Object, e As EventArgs)
        ...
        If Not executeScript(vParameterName, vSelectedItem) Then
            Exit Sub
        End If
        ' SendKeys.Send("{TAB}")
        ...
        For Each aa In iListObj
            ...
            If vStatus = "A" Then
                ...
                radBtn = New CheckBox With {
                                .Text = vTile,
                                .Name = vName,'"option" + vRadioIndex.ToString,
    ...
    Sub setDefaultValue(vDefaultValue_ As String)
        Dim valueList As String() = vDefaultValue_.Split(",")
        'reset all
        ...
        For Each v In valueList
            Dim checkbox1 As CheckBox = CType(Me.Controls(v), CheckBox)
            checkbox1.Checked = True
        Next
    End Sub

    Function getOptionChecked() As String
        vSelectedList = ""
        For Each c In Me.Controls
            If TypeOf c Is CheckBox Then
                If c.checked Then
                    vSelectedList = vSelectedList & c.name & ","
                End If
            End If
        Next
    ...
    Private Sub option_Click(sender As Object, e As EventArgs)
        ...
        vSelectedValue = getOptionChecked()
        vDefaultValue = vSelectedValue
        executeScript(vParameterName, vSelectedValue)
    End Sub
